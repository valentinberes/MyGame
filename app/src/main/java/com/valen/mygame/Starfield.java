...
public class Starfield {
	...
	public void draw(float[] mvpMatrix, float scroll) {
		...
		GLES32.glVertexAttribPointer(vsTextureCoord, COORDS_PER_TEXTURE,
				GLES32.GL_FLOAT, false,
		...
		int fsScroll = GLES32.glGetUniformLocation(mProgram, "scroll");
		GLES32.glUniform1i(fsTexture, 0);
		GLES32.glUniform1f(fsScroll, scroll);
